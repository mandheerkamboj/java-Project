    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-33">
            ...
            <b> Action:</b>
            <label for="approved"> 
            <input type="radio" id="approved" value="Approved" name="action" required>:Approve</label>
            <label for="Decline"> 
            <input type="radio" id="Decline" value="Declined" name="action" required checked>:Decline</label>
